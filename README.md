...
vOcsCore=3.3.0
vPluginsCommon=my-company-2.4.0
vOcsCom=my-company-2.4.0
vOcsDiag=my-company-2.4.0
vOcsNvM=my-company-2.4.0
vOcsEcuState=my-company-2.4.0
vOcsRuntime=my-company-2.4.0
vOcsSecurity=my-company-2.4.0
```
...
```groovy
ocs-communication-plugin-2.4.0.jar            // without adaptions
ocs-communication-plugin-my-company-2.4.0.jar // with adaptions
```
...
```batch
C:\Users\<your user account>\.m2\repository\com\vector\ocs\plugins\ocs-communication-plugin\my-company-2.4.0\ocs-communication-plugin-my-company-2.4.0.jar
```
...
| v2.3.0  | MICROSAR Automation SDK v2.1.0 | R35 - R36                          |
| v2.4.0  | MICROSAR Automation SDK v2.2.0 | R35 - R37                          |
