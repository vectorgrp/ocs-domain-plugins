...
vOcsCore=1.7.2
vPluginsCommon=my-company-1.5.2
vOcsCom=my-company-1.8.2
vOcsDiag=my-company-1.8.2
vOcsNvM=my-company-1.8.2
vOcsEcuState=my-company-1.8.2
vOcsRuntime=my-company-1.8.2
vOcsSecurity=my-company-1.6.2
```
...
```groovy
ocs-communication-plugin-1.7.2.jar            // without adaptions
ocs-communication-plugin-my-company-1.7.2.jar // with adaptions
```
...
| v1.8.2  | MICROSAR Automation SDK v1.7.2 | R31 - R34                          |
